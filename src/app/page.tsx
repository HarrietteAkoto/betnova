...
import { 
  ...
  Timer, LayoutGrid, Activity, History, ClipboardList, Home, Target, ArrowLeft, ShieldAlert
} from "lucide-react";
...
export default function Home() {
  const { selections, stake, setStake, removeSelection, clearBetslip, placeBet, claimDailyBonus, hasClaimedBonus, totalWagered, addSelection, isCoolOffActive, applyPromoCode, activateCoolOff, deactivateCoolOff, currency, setCurrency, favorites, toggleFavorite } = useBetslipStore();
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white font-sans pb-24 lg:pb-0">
      ...
      <main className="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* RIGHT SIDEBAR: BETSLIP COMPONENT */}
